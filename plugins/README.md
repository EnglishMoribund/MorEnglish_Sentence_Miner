...
| `discuss/` | `node discuss/discuss.mjs -- claude -p` (or `grok -p`, …) | any AI CLI — talks about the tags **you already chose** and prints the critique to your terminal; pushes nothing back |
